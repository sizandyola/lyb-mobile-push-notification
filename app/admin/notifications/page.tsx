    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          {loadingStats ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <p className="text-sm text-blue-600 font-medium">Active Tokens</p>
                <p className="text-3xl font-bold text-blue-900">{stats.totalActiveTokens}</p>
              </div>
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                <p className="text-sm text-green-600 font-medium">Sent (24h)</p>
                <p className="text-3xl font-bold text-green-900">{stats.notificationsSent24h}</p>
              </div>
              <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                <p className="text-sm text-purple-600 font-medium">Total Sent</p>
                <p className="text-3xl font-bold text-purple-900">{stats.totalNotificationsSent}</p>
              </div>
              {stats.platformBreakdown.length > 0 && (
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 md:col-span-3">
                  <p className="text-sm text-gray-600 font-medium mb-2">Platform Breakdown</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-6 text-gray-800">Send Broadcast Notification</h2>
          ...
          <div className="space-y-4">
            ...
            {/* Body */}
            <div>
              <label className="block font-medium mb-2 text-gray-700">Body</label>
              <textarea
                value={body}
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                This will send a notification to all <strong>{stats?.totalActiveTokens || 0}</strong> active devices.
              </p>
            </div>
            ...
            {result && (
              <div className={`p-4 rounded-lg ${result.success ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                ...
                <pre className={`text-sm overflow-auto ${result.success ? 'text-green-800' : 'text-red-800'}`}>
